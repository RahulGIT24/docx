...
export const Navbar = () => {
  ...
  const onSaveJSON = () => {
    ...
    onDownload(blob, `Document.json`); // do use doc name
  };
  const onSaveHTML = () => {
    if (!editor) return;
    ...
    onDownload(blob, `Document.html`); // do use doc name
  };
  const onSaveText = () => {
    if (!editor) return;
    ...
    onDownload(blob, `Document.txt`); // do use doc name
  };
    ...
    <nav className="flex items-center justify-between">
      <div className="flex gap-2 items-center">
        ...
        <div className="flex flex-col">
          <DocumentInput name={doc?.name ?? ""} doc_id={doc?.id as number} />
          <div className="flex">
